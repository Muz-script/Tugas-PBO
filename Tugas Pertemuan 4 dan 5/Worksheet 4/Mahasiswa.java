...
public class Mahasiswa {
    ...
    private int umur;
    private Date tglLahir;     // atribut baru
    private String[] skills;   // atribut baru
    ...
    // Getter & Setter untuk tglLahir (dengan defensive copy)
    ...
    // Getter & Setter untuk skills (dengan defensive copy)
